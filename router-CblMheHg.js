...
function ThemeProvider({ children }) {
  ...
  reactExports.useEffect(() => {
    const saved = typeof window !== "undefined" && localStorage.getItem("sentira-theme");
...
const appCss = "/assets/styles-BM0X-T3w.css";
...
const Route$2 = createRootRoute({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Sentira is a calm, intelligent wellness dashboard. Track heart rate, sleep, mood and stress with beautiful real-time insights."
      },
      { name: "author", content: "Sentira" },
      { property: "og:title", content: "Sentira — Wellness, with clarity" },
      {
        property: "og:description",
        content: "A premium wellness dashboard for tracking your daily and weekly rhythm."
      },
...
const $$splitComponentImporter$1 = () => import("./dashboard-C599HyKh.js");
const Route$1 = createFileRoute("/dashboard")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-Cp7DXAaQ.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Sign in to Sentira: a calm, premium wellness dashboard for heart rate, sleep, mood and stress."
    }]
  }),
