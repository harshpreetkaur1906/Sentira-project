import { $ as requireReact, r as reactExports, U as jsxRuntimeExports, P as getDefaultExportFromCjs, a0 as commonjsGlobal, a1 as React } from "./worker-entry-B6Zdqy5u.js";
import { u as useTheme, a as useNavigate, L as Link, r as reactDomExports, t as toast } from "./router-CblMheHg.js";
import { c as createLucideIcon, S as Sparkles, B as Button, a as Sun, M as Moon, b as clsx, m as motion, A as AuroraBackground, d as axios } from "./button-BhbdIqPy.js";
import "node:events";
...
const CirclePlus = createLucideIcon("circle-plus", __iconNode$9);
const __iconNode$8 = [
  [
    "path",
    {
...
const dayLabel$1 = (offset) => {
  const d = /* @__PURE__ */ new Date();
  d.setDate(d.getDate() - offset);
  return d.toISOString();
};
function deriveStress(hr, sleep, mood) {
...
[
  { id: "1", date: dayLabel$1(6), heartRate: 74, sleepHours: 6.2, moodScore: 6, stress: 0 },
  { id: "2", date: dayLabel$1(5), heartRate: 71, sleepHours: 7, moodScore: 7, stress: 0 },
  { id: "3", date: dayLabel$1(4), heartRate: 78, sleepHours: 5.8, moodScore: 5, stress: 0 },
  { id: "4", date: dayLabel$1(3), heartRate: 69, sleepHours: 7.6, moodScore: 8, stress: 0 },
  { id: "5", date: dayLabel$1(2), heartRate: 67, sleepHours: 8.1, moodScore: 9, stress: 0 },
  { id: "6", date: dayLabel$1(1), heartRate: 72, sleepHours: 7.2, moodScore: 7, stress: 0 },
  { id: "7", date: dayLabel$1(0), heartRate: 68, sleepHours: 7.8, moodScore: 8, stress: 0 }
...
const stressLabel = (s2) => {
  if (s2 < 33) return { label: "Calm", tone: "success" };
  if (s2 < 66) return { label: "Elevated", tone: "warning" };
...
function useUser() {
  ...
  reactExports.useEffect(() => setUser(getUser()), []);
  return user;
}
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-50 glass-strong border-b border-glass-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex h-16 max-w-7xl items-center gap-4 px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/dashboard", className: "flex items-center gap-2.5", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "ml-6 hidden items-center gap-1 text-sm md:flex", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Link,
      {
        to: "/dashboard",
        className: "rounded-full px-3 py-1.5 text-muted-foreground transition-colors hover:bg-muted hover:text-foreground",
        activeProps: {
          className: "rounded-full px-3 py-1.5 bg-muted text-foreground"
        },
        children: "Dashboard"
      }
    ) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ml-auto flex items-center gap-1.5 relative", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute right-2.5 top-2.5 h-2 w-2 rounded-full bg-[oklch(0.78_0.16_45)] shadow-[0_0_8px_oklch(0.78_0.16_45)]" })
            ]
          }
        ),
        open && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute right-0 mt-2 w-64 rounded-xl bg-black/80 backdrop-blur p-4 text-sm shadow-lg z-50", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "No notifications yet 🔔" }) })
      ] }),
      localStorage.getItem("token") && /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          variant: "ghost",
          size: "icon",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ml-1 grid h-10 w-10 place-items-center rounded-2xl bg-gradient-warm text-sm font-semibold text-foreground/80 ring-soft", children: initials })
    ] })
  ] }) });
}
  ...
  return /* @__PURE__ */ reactExports.createElement(PieLabelListProvider, {
    ...
    sectors === null || sectors === void 0 || sectors.forEach((entry, index) => {
      ...
      if (prev) {
        ...
        var latest2 = _objectSpread$g(_objectSpread$g({}, entry), {}, {
...
function CountUp({
  ...
  reactExports.useEffect(() => {
    ...
    let raf = 0;
    const step = (now) => {
      const p = Math.min(1, (now - t02) / duration);
...
function Sparkline({ data, color: color2 }) {
  const points = data.map((v, i) => ({ i, v }));
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 42, children: /* @__PURE__ */ jsxRuntimeExports.jsx(LineChart, { data: points, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Line, { type: "monotone", dataKey: "v", stroke: color2, strokeWidth: 2, dot: false }) }) });
}
function getLatest(logs) {
  return logs?.length ? logs[logs.length - 1] : null;
}
function getStressValue(l) {
  if (!l) return 30;
...
function CardShell({ title, icon: Icon, accent, children, delay = 0 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { className: "glass rounded-3xl p-6", children: [
...
function HeartRateCard({ logs }) {
  const latest2 = getLatest(logs);
  const value = latest2?.heartRate ?? 0;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(CardShell, { title: "Heart Rate", icon: Heart, accent: "", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CountUp, { value }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Sparkline,
      {
...
function SleepCard({ logs }) {
  const latest2 = getLatest(logs);
  const value = latest2?.sleepHours ?? 0;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(CardShell, { title: "Sleep", icon: Moon, accent: "", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CountUp, { value }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Sparkline,
      {
...
function MoodCard({ logs }) {
  const latest2 = getLatest(logs);
  const value = latest2?.moodScore ?? 0;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(CardShell, { title: "Mood", icon: Smile, accent: "", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CountUp, { value }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: moodEmoji(value) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Sparkline,
      {
...
function StressCard({ logs }) {
  const latest2 = getLatest(logs);
  const stressValue = getStressValue(latest2);
  const { label } = stressLabel(stressValue);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(CardShell, { title: "Stress", icon: Activity, accent: "", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CountUp, { value: stressValue }),
...
const dayLabel = (iso) => new Date(iso).toLocaleDateString(void 0, { weekday: "short" });
function ChartCard({
  title,
  subtitle,
  children,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-5 h-[260px]", children })
      ]
    }
  );
}
...
function HeartRateChart({ logs }) {
  const data = logs.map((l) => ({ day: dayLabel(l.date), hr: l.heartRate }));
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ChartCard, { title: "Weekly Rhythm", subtitle: "Heart rate across the last 7 days", delay: 0.25, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(LineChart, { data, margin: { top: 10, right: 10, left: -20, bottom: 0 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "hrLine", x1: "0", y1: "0", x2: "1", y2: "0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", stopColor: "oklch(0.7 0.2 15)" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: "oklch(0.7 0.18 320)" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CartesianGrid, { stroke: "var(--border)", strokeDasharray: "3 6", vertical: false }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { dataKey: "day", tickLine: false, axisLine: false, stroke: "var(--muted-foreground)", fontSize: 12 }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { tickLine: false, axisLine: false, stroke: "var(--muted-foreground)", fontSize: 12 }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { contentStyle: tooltipStyle, cursor: { stroke: "var(--border)" } }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Line,
      {
        type: "monotone",
...
function SleepChart({ logs }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ChartCard, { title: "Sleep Trend", subtitle: "Hours of restorative rest", delay: 0.3, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AreaChart, { data, margin: { top: 10, right: 10, left: -20, bottom: 0 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "sleepFill", x1: "0", y1: "0", x2: "0", y2: "1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", stopColor: "oklch(0.7 0.13 260)", stopOpacity: 0.55 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: "oklch(0.7 0.13 260)", stopOpacity: 0.02 })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CartesianGrid, { stroke: "var(--border)", strokeDasharray: "3 6", vertical: false }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { dataKey: "day", tickLine: false, axisLine: false, stroke: "var(--muted-foreground)", fontSize: 12 }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { tickLine: false, axisLine: false, stroke: "var(--muted-foreground)", fontSize: 12 }),
...
function MoodChart({ logs }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ChartCard, { title: "Mood Wave", subtitle: "Daily mood scores out of 10", delay: 0.35, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data, margin: { top: 10, right: 10, left: -20, bottom: 0 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "moodBar", x1: "0", y1: "0", x2: "0", y2: "1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", stopColor: "oklch(0.82 0.15 80)" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: "oklch(0.78 0.16 45)" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CartesianGrid, { stroke: "var(--border)", strokeDasharray: "3 6", vertical: false }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { dataKey: "day", tickLine: false, axisLine: false, stroke: "var(--muted-foreground)", fontSize: 12 }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { domain: [0, 10], tickLine: false, axisLine: false, stroke: "var(--muted-foreground)", fontSize: 12 }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { contentStyle: tooltipStyle, cursor: { fill: "color-mix(in oklab, var(--foreground) 5%, transparent)" } }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "mood", fill: "url(#moodBar)", radius: [10, 10, 4, 4], animationDuration: 1100 })
  ] }) }) });
}
function StressDonut({ logs }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ChartCard, { title: "Stress Distribution", subtitle: "How your week balanced out", delay: 0.4, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid h-full grid-cols-[1fr_auto] items-center gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PieChart, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Pie,
        {
          ...
          stroke: "none",
          animationDuration: 1100,
          children: data.map((d) => /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: d.color }, d.name))
        }
      )
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3 pr-2 text-sm", children: data.map((d) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-2.5 w-2.5 rounded-full", style: { background: d.color } }),
...
function HeroInsight({ logs }) {
  const latest2 = logs?.length ? logs[logs.length - 1] : null;
  const stressValue = typeof latest2?.stress === "number" ? latest2.stress : latest2?.stressStatus === "High" ? 90 : latest2?.stressStatus === "Medium" ? 60 : 30;
  const { label } = stressLabel(stressValue);
  const avgSleep = logs.length ? (logs.reduce((s2, l) => s2 + (l.sleepHours || 0), 0) / logs.length).toFixed(1) : "0.0";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.section,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative grid items-center gap-8 md:grid-cols-[1.4fr_1fr]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-2 rounded-full border border-glass-border bg-background/40 px-3 py-1 text-xs font-medium text-muted-foreground backdrop-blur", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "h-3.5 w-3.5 text-[oklch(0.7_0.18_295)]" }),
              "Today’s Balance"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "mt-4 font-display text-4xl font-semibold leading-[1.05] tracking-tight sm:text-5xl", children: [
              "Your wellness is",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient-primary", children: label.toLowerCase() }),
              ",",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-4 max-w-xl text-base text-muted-foreground sm:text-lg", children: [
              ...
              " of sleep this week and your heart rhythm has stayed within a healthy resting band. Keep flowing."
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(BreathingOrb, {})
        ] })
      ]
    }
  );
...
function BreathingOrb() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto grid h-56 w-56 place-items-center sm:h-64 sm:w-64", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        className: "absolute inset-0 rounded-full",
        style: {
          background: "radial-gradient(circle at 30% 30%, oklch(0.85 0.13 295 / 0.9), oklch(0.78 0.1 230 / 0.5) 60%, transparent 75%)",
          filter: "blur(2px)"
        },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        style: {
          background: "radial-gradient(circle at 60% 40%, oklch(0.85 0.14 80 / 0.7), transparent 65%)"
        },
        animate: { scale: [1, 1.12, 1] },
        transition: { duration: 6, repeat: Infinity, ease: "easeInOut", delay: 0.4 }
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative grid h-28 w-28 place-items-center rounded-full bg-background/50 backdrop-blur ring-soft", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Wind, { className: "h-6 w-6 text-foreground/70" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -bottom-7 text-xs uppercase tracking-[0.2em] text-muted-foreground", children: "Breathe" })
    ] })
  ] });
}
function AIInsightCard() {
  ...
  reactExports.useEffect(() => {
    const t = setInterval(() => setIdx((i) => (i + 1) % insights.length), 7e3);
    ...
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grid h-9 w-9 place-items-center rounded-2xl bg-gradient-primary text-primary-foreground shadow-glow", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "h-4 w-4" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-semibold", children: "AI Wellness Insight" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(motion.p, { className: "mt-4 text-base text-foreground/85", children: insights[idx] }, idx)
      ]
    }
  );
}
function MindfulnessQuote() {
  const q = quotes[(/* @__PURE__ */ new Date()).getDay() % quotes.length];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { className: "glass rounded-3xl p-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Quote, { className: "h-6 w-6 text-[oklch(0.7_0.16_75)]" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-3 font-display text-lg", children: [
      "“",
      q.q,
      "”"
    ] }),
...
function RecentLogs({ logs }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { className: "glass rounded-3xl p-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-semibold", children: "Recent Wellness Logs" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "mt-5 divide-y", children: recent.map((l) => {
      const stressValue = typeof l.stress === "number" ? l.stress : l.stressStatus === "High" ? 90 : l.stressStatus === "Medium" ? 60 : 30;
      const { label } = stressLabel(stressValue);
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "py-3 text-sm", children: [
        l.heartRate,
        " bpm · ",
        l.sleepHours,
        "h · mood ",
...
const empty = { heartRate: "", sleepHours: "", moodScore: "" };
function LogForm({
  onSubmit
}) {
  const [v, setV] = reactExports.useState(empty);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.form,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-semibold", children: "Log Today’s Wellness" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-muted-foreground", children: "A few seconds of input keeps your insights sharp." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-5 grid gap-4 sm:grid-cols-3", children: fields.map((f) => {
            const Icon = f.icon;
            const err = errors[f.key];
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "group relative block", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mb-1.5 block text-xs font-medium uppercase tracking-wider text-muted-foreground", children: f.label }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  className: `flex items-center gap-2 rounded-2xl border bg-background/60 px-3.5 py-2.5 transition-all focus-within:border-primary/60 focus-within:shadow-[0_0_0_4px_color-mix(in_oklab,var(--primary)_18%,transparent)] ${err ? "border-destructive/60" : "border-border"}`,
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: f.suffix })
                  ]
                }
              ),
              err && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mt-1 block text-xs text-destructive", children: err })
            ] }, f.key);
          }) }),
...
function Dashboard() {
  ...
  if (!authChecked) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative min-h-screen", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AuroraBackground, {}) });
  }
  const greeting = (() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative min-h-screen", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "mx-auto max-w-7xl space-y-8 px-4 py-8 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        ...
        duration: 0.6
      }, className: "flex flex-wrap items-end justify-between gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm uppercase tracking-[0.18em] text-muted-foreground", children: today }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-1 font-display text-3xl font-semibold tracking-tight sm:text-4xl", children: [
            greeting,
            ", ",
            userName.split(" ")[0],
            "."
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "#log-today", className: "inline-flex items-center gap-2 rounded-full bg-gradient-primary px-5 py-2.5 text-sm font-medium text-primary-foreground shadow transition-transform hover:-translate-y-0.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CirclePlus, { className: "h-4 w-4" }),
          "Log today’s data"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(HeroInsight, { logs }),
      !ready ? /* @__PURE__ */ jsxRuntimeExports.jsx(SkeletonGrid, {}) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-5 sm:grid-cols-2 xl:grid-cols-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(HeartRateCard, { logs }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(SleepCard, { logs }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(MoodCard, { logs }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(StressCard, { logs })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "log-today", className: "grid gap-5 lg:grid-cols-[1.4fr_1fr]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(LogForm, { onSubmit: addLog }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(AIInsightCard, {})
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-5 lg:grid-cols-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(HeartRateChart, { logs }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(SleepChart, { logs })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-5 lg:grid-cols-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(MoodChart, { logs }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(StressDonut, { logs })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-5 lg:grid-cols-[1.4fr_1fr]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(RecentLogs, { logs }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(MindfulnessQuote, {})
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "pb-8 pt-6 text-center text-xs text-muted-foreground", children: "Sentira · Wellness, with clarity." })
    ] })
  ] });
}
function SkeletonGrid() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-5 sm:grid-cols-2 xl:grid-cols-4", children: Array.from({
    length: 4
  }).map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "glass h-[180px] rounded-3xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "shimmer h-full w-full" }) }, i)) });
}
export {
